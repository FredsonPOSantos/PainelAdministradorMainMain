  ...
  apps: [
    {
      ...
      env: {
        ...
        // [CORRIGIDO] Deve apontar para o IP do servidor onde o frontend está, na porta 8184.
    ...
    },
    {
      ...
      // [CORRIGIDO] Argumentos: pasta frontend, porta 8184, sem cache (-c-1), habilitar CORS.
